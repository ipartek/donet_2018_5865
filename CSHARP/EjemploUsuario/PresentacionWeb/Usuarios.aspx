...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ClientIDMode="Static">
    <div style="margin-top: 1em">
        ...
        <div class="form-group row">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtPassword" Display="Dynamic" ErrorMessage="Es obligatorio rellenar la contraseña" ValidationGroup="usuario">*</asp:RequiredFieldValidator>
        ...
        <div class="form-group row">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="El DNI es obligatorio" ControlToValidate="TxtDni" Display="Dynamic" ValidationGroup="usuario">*</asp:RequiredFieldValidator>
        ...
        <div class="form-group row">
            <asp:Button CssClass="btn btn-primary offset-sm-2" ID="BtnAceptar" runat="server" Text="Aceptar" OnClick="BtnAceptar_Click"  ValidationGroup="usuario"/>
